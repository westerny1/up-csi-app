    ...
    <main class="flex justify-evenly">
        <div class="bg-csi-neutral-900 w-3/7 rounded-md p-6">
            ...
            <div class="flex justify-between">
                ...
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">Membership & Internals</h3>
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">Service</h3>
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">Innovation</h3>
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">Engineering</h3>
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">External Relations</h3>
                <p class="text-csi-white">12/34</p>
            </div>

            <div class="flex justify-between">
                <h3 class="text-csi-white">Branding and Creatives</h3>
                <p class="text-csi-white">12/34</p>
            </div>
        </div>
        ...
        <div class="bg-csi-neutral-900 w-3/7 rounded-md p-6">
            ...
            <div class="flex justify-between">
                ...
                <p class="text-csi-white">28/40</p>
            </div>
